 ...
 * {@hide}
 */
public class lt02lteRil extends RIL {
    ...
    public lt02lteRil(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public lt02lteRil(Context context, int preferredNetworkType, int cdmaSubscription, Integer instanceId) {
    ...
    processSolicited (Parcel p) {
        ...
        try { switch (rr.mRequest) {
            case RIL_REQUEST_OPERATOR:
                ...
                Rlog.v(RILJ_LOG_TAG, "lt02lteRil: Operator response");
       
                if (operators == null || operators.length < 0) {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: operators is empty or null");
                } else {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: length of operators:"+operators.length);
                   for (int i = 0; i < operators.length; i++) {
                      Rlog.v(RILJ_LOG_TAG, "lt02lteRil: operator["+i+"]:"+operators[i]);
                   }
                } 

                Rlog.v(RILJ_LOG_TAG, "lt02lteRil: Forcing operator name using build property ro.cdma.home.operator.alpha");
            ...
            case RIL_REQUEST_VOICE_REGISTRATION_STATE:
                ...
                Rlog.v(RILJ_LOG_TAG, "lt02lteRil: VoiceRegistrationState response");

                if (voiceRegStates == null || voiceRegStates.length < 0) {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: voiceRegStates is empty or null");
                } else {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: length of voiceRegStates:"+voiceRegStates.length);
                   for (int i = 0; i < voiceRegStates.length; i++) {
                      Rlog.v(RILJ_LOG_TAG, "lt02lteRil: voiceRegStates["+i+"]:"+voiceRegStates[i]);
                   }
                }
             ...
             case RIL_REQUEST_DATA_REGISTRATION_STATE:
                ...
                Rlog.v(RILJ_LOG_TAG, "lt02lteRil: DataRegistrationState response");
               
                if (dataRegStates == null || dataRegStates.length < 0) {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: dataRegStates is empty or null");
                } else {
                   Rlog.v(RILJ_LOG_TAG, "lt02lteRil: length of dataRegStates:"+dataRegStates.length);
                   for (int i = 0; i < dataRegStates.length; i++) {
                      Rlog.v(RILJ_LOG_TAG, "lt02lteRil: dataRegStates["+i+"]:"+dataRegStates[i]);
                   }
                }
